...
Para utilizar o script será necessário instalar as dependências necessárias
    Execute o seguinte comando no terminal para instalar todas as bibliotecas listadas:
